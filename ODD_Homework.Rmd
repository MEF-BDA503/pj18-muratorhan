...
```{r}
saveRDS(car_data_june_16,file="~/C:\Users\Murat\Desktop\BİG DATA YL\BDA 503 DATA ANALYTICS(R)\W2\ODD/odd_car_sales_data_june_16.rds")
# You can read that file by readRDS and assigning to an object 
# e.g 
# rds_data <- readRDS("~/C:\Users\Murat\Desktop\BİG DATA YL\BDA 503 DATA ANALYTICS(R)\W2\ODD/odd_car_sales_data_june_16.rds")
```
